...
class FollowingActionTest extends WebTestCase
{
    public function testMainPage(): void
    {
        ...
        $client->request('GET', '/@person/following');
        ...
        self::assertEquals([
            ...
            'totalItems' => 9,
            'first' => 'https://localhost/@person/following?page=1',
            'id' => 'https://localhost/@person/following',
    ...
    public function testFirstPage(): void
    {
        ...
        $client->request('GET', '/@person/following?page=1');
        self::assertResponseIsSuccessful();
        ...
        self::assertEquals([
            ...
            'totalItems' => 4,
            'partOf' => 'https://localhost/@person/following',
            'orderedItems' => [
            ...
            'id' => 'https://localhost/@person/following?page=1',
        ], json_decode($content, true, 512, JSON_THROW_ON_ERROR));
    }
}
